...
import CombColorsData from "../../ColorData/CombColorsData";
...
function CombColors() {
  ...
  const transition = useTransition(open ? CombColorsData : [], {
    ref: transApi,
    trail: 400 / CombColorsData.length,
